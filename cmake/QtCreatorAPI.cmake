...
function(qtc_copy_to_builddir custom_target_name)
  ...
  foreach(url ${_arg_URLS})
    ...
    string(APPEND scriptContent "execute_process(\n")
    string(APPEND scriptContent "  COMMAND \"${CMAKE_COMMAND}\" -E tar xzvf \"${downloadPath}\" WORKING_DIRECTORY \"${destinationDirectory}\"\n")
    string(APPEND scriptContent "  COMMAND \"${CMAKE_COMMAND}\" -E remove \"${downloadPath}\"\n")
    string(APPEND scriptContent ")\n")
