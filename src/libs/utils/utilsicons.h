...
QTCREATOR_UTILS_EXPORT extern const Icon DEBUG_TOOLBAR;
// OPENMV-DIFF
...
// OPENMV-DIFF //
QTCREATOR_UTILS_EXPORT extern const Icon WRAP;
QTCREATOR_UTILS_EXPORT extern const Icon WRAP_TOOLBAR;
// OPENMV-DIFF //
