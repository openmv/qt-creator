...
QString opcodeName(quint8 opcode);   // for logging OMVPOpcode from a raw byte
QString eventTypeName(quint16 evt);  // for logging OMVPEventType from a raw 16-bit value
