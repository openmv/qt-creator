...
typedef QMultiMap<double, QCPData>::iterator QCPDataMapIterator;
typedef QMultiMap<double, QCPData>::const_iterator QCPDataMutableMapIterator;
...
typedef QMultiMap<double, QCPCurveData>::iterator QCPCurveDataMapIterator;
typedef QMultiMap<double, QCPCurveData>::const_iterator QCPCurveDataMutableMapIterator;
...
typedef QMultiMap<double, QCPBarData>::iterator QCPBarDataMapIterator;
typedef QMultiMap<double, QCPBarData>::const_iterator QCPBarDataMutableMapIterator;
...
typedef QMultiMap<double, QCPFinancialData>::iterator QCPFinancialDataMapIterator;
typedef QMultiMap<double, QCPFinancialData>::const_iterator QCPFinancialDataMutableMapIterator;
