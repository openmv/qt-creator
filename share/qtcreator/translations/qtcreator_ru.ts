...
Please run Examples-&gt;OpenMV-&gt;Basics-&gt;helloworld.py to test the vision quality and focus the camera (if applicable).</source>
        <translation>OpenMV Cam автоматически регистрируется!
...
Continue?</source>
        <translation>OpenMV IDE все еще может попытаться обновить вашу OpenMV Cam с помощью начального загрузчика DFU OpenMV Cam.
