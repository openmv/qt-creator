...
build_time_vars = {
    ...
    'AR': '/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/llvm/bin/llvm-ar',
    'ARFLAGS': 'rcs',
    ...
    'BLDSHARED': 'clang -bundle -undefined dynamic_lookup -arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    ...
    'CONFIGURE_CFLAGS': '-arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new',
    ...
    'CONFIGURE_CPPFLAGS': '-arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new',
    'CONFIGURE_LDFLAGS': '-arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl',
    'CONFIGURE_LDFLAGS_NODIST': '-flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,"$@".lto -g',
    'CONFIGURE_LDFLAGS_NOLTO': '-flto=thin',
    'CONFIG_ARGS': "'--build=aarch64-apple-darwin' '--host=aarch64-apple-darwin' '--prefix=/install' '--with-openssl=/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/deps' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' '--enable-shared' '--enable-optimizations' '--with-lto' '--with-build-python=/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/host/bin/python3.13' 'ac_cv_lib_intl_textdomain=no' 'ac_cv_func_ptsname_r=no' '--with-dbmliborder=ndbm' 'build_alias=aarch64-apple-darwin' 'host_alias=aarch64-apple-darwin' 'CC=clang' 'CFLAGS=-arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new' 'LDFLAGS=-arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl' 'CPPFLAGS=-arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new'",
    'CONFINCLUDEDIR': '/install/include',
    'CONFINCLUDEPY': '/install/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new',
    'CXX': 'clang++',
    ...
    'FREEZE_MODULE': '/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/host/bin/python3.13 ./Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': '/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/host/bin/python3.13 ./Programs/_freeze_module.py',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'clang++ -bundle -undefined dynamic_lookup -arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl',
    'LDFLAGS': '-arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl',
    'LDLIBRARY': 'libpython3.13.dylib',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'clang -bundle -undefined dynamic_lookup -arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl',
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/install/lib/python3.13',
    'LIBDIR': '/install/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/host/bin/python3.13',
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': '/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/host/bin/python3.13',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new',
    'PY_CFLAGS_NODIST': '-flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/code.profclangd -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -fprofile-instr-use=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl -flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,"$@".lto -g',
    'PY_CPPFLAGS': '-I. -I./Include -arch arm64 -mmacosx-version-min=11.0 -Wno-nullability-completeness -Wno-expansion-to-defined -Wno-undef-prefix  -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk -fPIC    -Werror=unguarded-availability-new',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl',
    'PY_LDFLAGS_NODIST': '-flto=thin -Wl,-export_dynamic -Wl,-object_path_lto,"$@".lto -g',
    'PY_LDFLAGS_NOLTO': '-arch arm64 -mmacosx-version-min=11.0 -isysroot /Applications/Xcode_15.2.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.2.sdk  -LModules/_hacl -flto=thin',
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'DYLD_LIBRARY_PATH=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'DYLD_LIBRARY_PATH=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0 _PYTHON_PROJECT_BASE=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/host/bin/python3.13',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'DYLD_LIBRARY_PATH=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0 _PYTHON_PROJECT_BASE=/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=$(shell test -f pybuilddir.txt && echo /private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0/`cat pybuilddir.txt`:)./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__darwin_darwin /var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/tools/host/bin/python3.13 -m test',
    ...
    'abs_builddir': '/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0',
    'abs_srcdir': '/private/var/folders/t_/mmhnh941511_hp2lwh383bp00000gn/T/tmpc74tdl4c/Python-3.13.0',
